...
bool DataBaseInterface::isInitialised() const
{
...
bool DataBaseInterface::batchProcessDomDocument( const QDomDocument* domDoc ) const
{
  BatchProcessorHelper helper( domDoc,
                                 SEPARATOR,
                                 knownElements(),
                                 knownAttributeKeys() );
...
bool DataBaseInterface::addElement( const QString& element, const QStringList& children, const QStringList& attributes ) const
{
  if( element.isEmpty() )
  {
...
bool DataBaseInterface::updateElementChildren( const QString& element, const QStringList& children, bool replace ) const
{
  if( element.isEmpty() )
  {
...
bool DataBaseInterface::updateElementAttributes( const QString& element, const QStringList& attributes, bool replace ) const
{
  if( element.isEmpty() )
  {
    m_lastErrorMsg = QString( "Invalid element name provided." );
...
bool DataBaseInterface::updateAttributeValues( const QString& element, const QString& attribute, const QStringList& attributeValues, bool replace ) const
{
...
bool DataBaseInterface::removeChildElement( const QString& element, const QString& child ) const
{
  QSqlQuery query = selectElement( element );
...
bool DataBaseInterface::removeAttribute( const QString& element, const QString& attribute ) const
{
  QSqlQuery query = selectAttribute( attribute, element );
...
bool DataBaseInterface::hasActiveSession() const
{
...
QString DataBaseInterface::activeSessionName() const
{
...
bool DataBaseInterface::isUniqueChildElement( const QString& parentElement, const QString& element ) const
{
...
{
  BatchProcessorHelper helper( doc,
                                 SEPARATOR,
                                 knownElements(),
                                 knownAttributeKeys() );
  ...
  /* If there are no new items, we may still have previously unknown relationships which we
    ...
    Also remember that the lists returned by BatchProcessorHelper are all synchronised
...
QStringList DataBaseInterface::attributeValues( const QString& element, const QString& attribute ) const
{
  QSqlQuery query = selectAttribute( attribute, element );
...
bool DataBaseInterface::containsKnownRootElement( const QString& dbName, const QString& root ) const
{
...
QStringList DataBaseInterface::connectionList() const
{
  return m_dbMap.keys();
}
...
const QString& DataBaseInterface::lastError() const
{
...
bool DataBaseInterface::addDatabase( const QString& dbName )
{
  if( !dbName.isEmpty() )
  {
    /* In case the db name passed in consists of a path/to/file string. */
...
bool DataBaseInterface::removeDatabase( const QString& dbName )
{
  if( !dbName.isEmpty() )
  {
    /* In case the db name passed in consists of a path/to/file string. */
...
bool DataBaseInterface::setActiveDatabase( const QString& dbName )
{
  /* In case the db name passed in consists of a path/to/file string. */
  QString dbConName = dbName.split( QRegExp( REGEXP_SLASHES ), QString::SkipEmptyParts ).last();
...
QStringList DataBaseInterface::knownAttributeKeys() const
{
  ...
  while( query.next() )
  {
    /* Concatenate the attribute name and associated element into a single string
      ...
      particular combination (this is used in BatchProcessorHelper). */
...
QSqlQuery DataBaseInterface::selectAttribute( const QString& attribute, const QString& associatedElement ) const
{
  QSqlQuery query( m_sessionDB );
...
bool DataBaseInterface::openConnection( const QString& dbConName )
{
...
void DataBaseInterface::saveDatabaseFile() const
{
  QFile flatFile( DB_FILE );
