...
AddItemsForm::AddItemsForm(QWidget *parent)
  ...
  connect(ui->comboBox, SIGNAL(activated(const QString &)), this,
          SLOT(comboValueChanged(const QString &)));
...
AddItemsForm::~AddItemsForm() { delete ui; }
    ...
    if (m_db.isProfileEmpty()) {
      ...
      if (ui->treeWidget->currentItem()) {
        ...
        MessageSpace::showErrorMessageBox(
            this, "Please select a parent element in the tree.");
        return;
      }
    }
  }
...
void AddItemsForm::showHelp() {
  QMessageBox::information(
      this, "How this works...",
      "The new (or existing) element will be added as a a child of the element "
      "highlighted "
      "in the \"Element Hierarchy\" tree (if the active profile is empty, the "
      "new element "
